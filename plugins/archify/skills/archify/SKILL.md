...
This copy is vendored in the `sunggom2/claude-toolkit` repository and is updated only by replacing its folder there. Do not run `scripts/check-update.mjs` and do not contact the update manifest.
